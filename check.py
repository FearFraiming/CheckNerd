...
def usage():
    ...
    print("+---------------+")
    print("")
    print("\033[1;36m     python2 check.py -b     [Opciones de uso]")
    print("     python2 check.py -h     Mensaje de ayuda")
    print("\033[1;31m")
    print("+-----------------+")
    ...
    print("")
    print("\033[1;36m     python2 check.py -b 123456xxxxxxxxxx -u 40 -d -c ")
    print("")
    print("\033[1;31m")
    print("+-----------------------+")
